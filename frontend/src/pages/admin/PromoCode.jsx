                    ...
                    <tbody>
                        {currentPromos.map((promo) => (
                            <tr key={promo._id} className="border-t hover:bg-gray-100">
                                <td className="p-5 font-medium text-gray-800">{promo.PromoCode}</td>
                                <td className="p-5">{promo.Discount}%</td>
                                <td className="p-5">{promo.userId}</td>
                                <td className="p-5">{new Date(promo.createdAt).toLocaleString()}</td>
                                <td className="p-5">
                                    <button className="mr-2 bg-green-600 text-white px-2 py-1 rounded">Edit</button>
                                    <button
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 relative">
                        ...
                        <h2 className="text-xl font-bold text-gray-800 mb-4">Add Promo Code</h2>
                        ...
                        <div className="flex border-b mb-4">
                            ...
                            <button
                                ...
                                className={`ml-4 px-4 py-2 text-sm font-medium ${activeTab === "single"
                                    ? "border-b-2 border-purple-600 text-purple-600"
                                    : "text-gray-500 hover:text-purple-600"
                                    }`}
                            >
                        ...
                        <button
                            ...
                            className="bg-purple-600 text-white px-4 py-2 mt-3  rounded-md hover:bg-purple-700"
                        >
